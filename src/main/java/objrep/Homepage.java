...
public class Homepage {
	...
	@FindBy(xpath="/html/body/header/nav/ul/li[6]/a") static WebElement Popitem;
	...
	@FindBy(xpath="//*[@id=\"Description\"]/h1") static WebElement tabedecp;
...
public static WebElement table_dec_text() {
	return tabedecp;
	
}
public static WebElement laptop_dec_text() {
	return laptopdescp;
	
}
public static WebElement spe_dec_text() {
	return spedesp;
